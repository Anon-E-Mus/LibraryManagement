...
public class BookController {
    ...
    public List<Book> findByAuth(@PathVariable String name) {
        return bookService.findByAuth(name);
    }
    
    @GetMapping("/borrowed")
    public List<Book> findBorrow() {
        return bookService.findBorrowed();
    }
    
    @GetMapping("/available")
    public List<Book> findAvail() {
